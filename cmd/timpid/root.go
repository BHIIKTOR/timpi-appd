...
func NewRootCmd() *cobra.Command {
	...
	tempApp := app.NewTimpiApp(log.NewNopLogger(), dbm.NewMemDB(), nil, false, simtestutil.NewAppOptionsWithFlagHome(tempDir()), []wasmkeeper.Option{})
