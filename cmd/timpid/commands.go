...
func appExport(
	...
	if height != -1 {
		if err := timpiApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	}

	return timpiApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs, modulesToExport)
}

var tempDir = func() string {
	dir, err := os.MkdirTemp("", "timpid")
	if err != nil {
